...
public class PairHandlerFactory
{
    ...
    public PairHandlerFactory(ILoggerFactory loggerFactory, GameObjectHandlerFactory gameObjectHandlerFactory, IpcManager ipcManager,
        ...
        ServerConfigurationManager serverConfigManager, VisibilityGateService visibilityGateService, SpheneConfigService spheneConfigService)
    {
    ...
    public PairHandler Create(Pair pair)
    {
        return new PairHandler(_loggerFactory.CreateLogger<PairHandler>(), pair, _gameObjectHandlerFactory,
            ...
            _fileCacheManager, _spheneMediator, _playerPerformanceService, _serverConfigManager, _visibilityGateService, _spheneConfigService);
    }
}
