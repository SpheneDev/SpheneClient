...
public record MoodlesMessage(IntPtr Address, string? MoodlesData = null) : MessageBase;
...
public record PlayNotificationSoundTestMessage(NotificationSoundConfig Config) : SameThreadMessage;
