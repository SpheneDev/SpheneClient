...
public sealed class OneTimeUpdateOptionsSummaryUi : WindowMediatorSubscriberBase
{
    ...
    public OneTimeUpdateOptionsSummaryUi(
        ...
        : base(logger, mediator, "What's New - Options Summary", performanceCollectorService)
    {
        _uiShared = uiShared;
    ...
    {
        UiSharedService.TextWrapped("This window summarizes new options added in this update for existing users.");
